...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file="train/split_train_annotation.json",
...
val_dataloader = dict(
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file="train/split_val_annotations.json",
        data_prefix=dict(img="train/images/"),
    )
)
...
val_evaluator = dict(
    metric="bbox",
    ann_file="/data3/QYB/data/RemoteSensing/train/split_val_annotations.json",
)
